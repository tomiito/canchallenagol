...
angular.module('notifications', []).
    factory('$notification', ['$timeout',function($timeout){
        ...
        return {
            ...
            info: function(title, content, userData){
                ...
                return this.awesomeNotify('info','exclamation', title, content, userData);
            },

            error: function(title, content, userData){
                return this.awesomeNotify('error', 'exclamation-circle', title, content, userData);
            },
    ...
    directive('notifications', ['$notification', '$compile', function($notification, $compile){
        ...
        var html =
            ...
            '<i class="fa fa-{{noti.icon}} fa-fw" ng-switch-when="false"></i>' +
